...
function About() {
  ...
  return (
    <div className="bg-gray-100 min-h-screen flex flex-col justify-center items-center text-center p-8">
    <h1 className="text-4xl font-bold text-gray-800 mb-4" data-aos="fade-up">
      من نحن
    </h1>
    <p className="text-lg text-gray-600 max-w-2xl mb-8" data-aos="fade-up">
      نحن نقدم تصاميم فريدة تعكس التراث العربي بأعلى معايير الجودة والاهتمام بالتفاصيل.
    </p>
    <div className="grid md:grid-cols-2 gap-8 w-full max-w-4xl">
      <div className="bg-white p-4 shadow-lg rounded-lg" data-aos="fade-right">
        <Image
          src={firstimg}
          alt="تصميم الثوب"
          className="rounded-lg mb-4 h-[40vh]"
        />
        <h2 className="text-2xl font-semibold text-gray-700">تصميم الثوب</h2>
      ...
      <div className="bg-white p-4 shadow-lg rounded-lg" data-aos="fade-left">
        ...
        />
        <h2 className="text-2xl font-semibold text-gray-700">تصنيع الثوب</h2>
